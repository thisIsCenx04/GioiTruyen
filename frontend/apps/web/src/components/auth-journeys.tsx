  ...
  return (
    <form className={styles.form} onSubmit={submit}>
      ...
      <p className={styles.hint}>
        Chưa có tài khoản?{" "}
        <Link className={styles.textLink} href={routes.register}>
          Tạo bản đọc riêng
        </Link>
      </p>
    </form>
...
export function RegisterJourney() {
  ...
  return (
    <form className={styles.form} onSubmit={submit}>
      ...
      <div className={styles.actions}>
        <Link href={routes.login}>Đã có tài khoản</Link>
        <button className={styles.primary} disabled={busy} type="submit">
  ...
  if (!token) {
    return (
      <>
        ...
        <Link className={styles.textLink} href={routes.login}>
          Trở về đăng nhập
        </Link>
      </>
    );
...
export function ForgotPasswordJourney() {
  ...
  return (
    <form className={styles.form} onSubmit={submit}>
      ...
      <div className={styles.actions}>
        <Link href={routes.login}>Trở về đăng nhập</Link>
        <button className={styles.primary} disabled={busy} type="submit">
