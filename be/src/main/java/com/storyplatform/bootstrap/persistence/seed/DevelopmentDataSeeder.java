...
public class DevelopmentDataSeeder implements ApplicationRunner {
    ...
    private static String reviewChapterContent(int number) {
        return """
                <p>Chương %02d mở ra một nhịp đọc dài hơn để kiểm tra giao diện reader,
                khoảng cách dòng và điều hướng chương kế tiếp.</p>
                <p>Người giữ đèn đi dọc bờ sông, ghi lại từng tín hiệu nhỏ trong tiếng nước
                và ánh sáng lam nhạt phía cuối bến.</p>
                <p>Khi chuông đồng hồ điểm nửa đêm, những mảnh ký ức cũ hiện lên theo
                thứ tự khác nhau, đủ dài để kiểm tra trạng thái cuộn trang.</p>
                <p>Ở cuối chương, nhân vật nhận ra ngọn đèn không chỉ dẫn đường cho
                người mất lối mà còn lưu lại lời hứa của cả thị trấn.</p>
                """.formatted(number);
    }
    ...
    private static String expandedChapterContent(
        ...
        return """
                <p>%s</p>
                <p>Ở chương %d, các nhân vật phải đối diện với hệ quả từ lựa chọn trước đó.
                Những chi tiết nhỏ dần nối lại thành một câu trả lời rõ ràng hơn.</p>
                <p>Không gian thành phố thay đổi theo từng khung giờ, còn cuộc trò chuyện
                dang dở buộc mọi người phải thành thật với điều mình thực sự mong muốn.</p>
